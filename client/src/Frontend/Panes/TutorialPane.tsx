...
function TutorialPaneContent({
  ...
  if (tutorialState === TutorialState.None) {
    ...
    return (
      <div>
        Well done! In the Selected Planet pane, you'll see more information
        about your planet. This pane displays quick information about your
        planet and the ability to send resources.
        <br />
        <br />
    ...
    return (
      <div>
        When you sent energy to a planet you accumulated some{" "}
        <White>Space Junk</White>. Sending energy to planets that no one has
        moved to yet will give you junk. You are not allowed to take on more
        junk than your maximum limit and will be unable to make moves.
        <br />
        <br />
    ...
    return (
      <div>
        ...
        move spaceships between any two planets, even if you don't own the
        source or destination planets. Space ships can move any distance!{" "}
    ...
    return (
      <div className="tutzoom">
        ...
        <br />
        <br />
        You'll notice a target <Icon type={IconType.Target} /> indicating where
        you are currently exploring.{" "}
        <White>Press next when you can see it.</White> You can also zoom using
        the mouse wheel.
        <div>
          <Btn
            className="btn"
    ...
    return (
      <div>
        ...
        <br />
        <White>
          Try moving your explorer by clicking on the Move{" "}
      ...
      <div className="tutzoom">
        ...
        <div>
          <Btn
            className="btn"
            onClick={() =>
              tutorialManager.acceptInput(TutorialState.ScoringDetails)
            }
          >
            Next
          </Btn>
    ...
    return (
      <div className="tutalmost">
        ...
        <div>
          <Btn
            className="btn"
            onClick={() => tutorialManager.acceptInput(TutorialState.Valhalla)}
          >
            Next
          </Btn>
        </div>
