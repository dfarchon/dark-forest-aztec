...
const icon = (modal: ModalName): React.ReactNode => {
  ...
  else if (modal === ModalName.PlanetDetails)
    return <Icon type={IconType.Planet} />;
  else if (modal === ModalName.Leaderboard)
    return <Icon type={IconType.Leaderboard} />;
  else if (modal === ModalName.PlanetDex)
    return <Icon type={IconType.PlanetDex} />;
  else if (modal === ModalName.UpgradeDetails)
    return <Icon type={IconType.Upgrade} />;
  else if (modal === ModalName.TwitterVerify)
    return <Icon type={IconType.Twitter} />;
  else if (modal === ModalName.Broadcast)
    return <Icon type={IconType.Broadcast} />;
  else if (modal === ModalName.MapShare) return <Icon type={IconType.Share} />;
  else if (modal === ModalName.ManageAccount)
  ...
  else if (modal === ModalName.WithdrawSilver)
