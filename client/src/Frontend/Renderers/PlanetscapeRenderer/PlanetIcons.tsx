import { EMPTY_ADDRESS, MAX_PLANET_LEVEL } from "@dfpunk/constants";
...
import { Planet, PlanetType, TooltipName } from "@dfpunk/types";
    ...
    <StyledPlanetIcons>
      ...
      {planet.destroyed && (
        <TooltipTrigger
          ...
          extraContent={
            <>
              This planet is destroyed. It does not generate energy or silver,
              all incoming voyages are void, and you cannot send or receive
              energy from it.
            </>
          }
        >
