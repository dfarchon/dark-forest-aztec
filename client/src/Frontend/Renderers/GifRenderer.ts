...
import { mockArtifactWithRarity } from "@dfpunk/procedural";
import { SpriteRenderer, WebGLManager } from "@dfpunk/renderer";
import { Artifact, ArtifactRarity, ArtifactType, Biome } from "@dfpunk/types";
