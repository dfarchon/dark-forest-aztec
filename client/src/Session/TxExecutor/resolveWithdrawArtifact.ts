/**
 * StateResolver: resolveWithdrawArtifact
 *
 * Contract signature:
 * withdraw_artifact(location_id, artifact_id, timestamp,
...
import type { UnconfirmedWithdrawArtifact } from "@dfpunk/types";
...
export async function resolveWithdrawArtifact(
  ...
  // Load the specific artifact being withdrawn
