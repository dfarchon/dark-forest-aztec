...
import { hasOwner, isActivated, isLocatable } from "@dfpunk/gamelogic";
import { bonusFromHex, getBytesFromHex } from "@dfpunk/hexgen";
import {
...
export class GameObjects {
  ...
  private removeArrival(planetId: LocationId, arrivalId: VoyageId) {
    ...
    const idx = planetArrivalIds.indexOf(arrivalId);
    if (idx !== -1) planetArrivalIds.splice(idx, 1);
  }
