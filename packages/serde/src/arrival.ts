...
// import type { DarkForest } from '@dfpunk/contracts/typechain';
// import type { ArrivalType, QueuedArrival, VoyageId } from '@dfpunk/types';
...
//  * to a `QueuedArrival` typescript typed object (see @dfpunk/types)
//  *
