...
import { getPlanetRank, isLocatable } from "@dfpunk/gamelogic";
import { seededRandom } from "@dfpunk/hashing";
...
import type { HSLVec, RGBAVec, RGBVec } from "@dfpunk/types";
import { Biome, HatType } from "@dfpunk/types";
...
const baseByBiome: { readonly [key: number]: HSLVec } = {
  [Biome.UNKNOWN]: [0, 0, 0],
...
const oceanByBiome: { readonly [key: number]: HSLVec } = {
  [Biome.UNKNOWN]: [0, 0, 0],
